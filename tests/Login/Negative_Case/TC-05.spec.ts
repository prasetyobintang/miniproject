...
test.describe('TC-05 - Negative Login', () => {
    ...
    test('User gagal login menggunakan username valid dan password kosong', async ({ page }) => {
        ...
        await page.screenshot({ path: 'screenshots/TC-05-username-filled.png' });

        await page.fill('#password', '');
        // Optional Screenshot after filling password
        await page.screenshot({ path: 'screenshots/TC-05-password-filled.png' });
        ...
        await page.screenshot({ path: 'screenshots/TC-05-login-failed-password-empty.png' });
    })
})
