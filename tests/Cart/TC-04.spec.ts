...
test.describe('User menghapus item dari halaman Cart', () => {
    // Define the individual test case
    test('TC-04 Cart - Remove from Cart Page', async ({ page }) => {
        // Identify Credential:
        ...
        await page.screenshot({ path: 'screenshots/Cart/TC-04-username-filled.png' });
        await page.fill('#password', password);
        // Optional Screenshot after filling password
        await page.screenshot({ path: 'screenshots/Cart/TC-04-password-filled.png' });
        ...
        // Step 8: Remove the item from the cart by clicking the "Remove" button
        await page.click('button[data-test="remove-sauce-labs-backpack"]');

        // Step 9: Verify the item is removed from the cart by checking the absence of the cart item
